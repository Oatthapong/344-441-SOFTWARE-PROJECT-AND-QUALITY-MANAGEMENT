            ...
            <div class="container m-auto">
                ...
                <form class="formSearchUser" method="get" action="showCourseFAdminFin.php">
                    <div class="topnav mt-3 mb-5 ml-3">
                        ...
                        <a href="AddCourseAdmin.php"><button class="btn-primary2 mx-4" type="button">เพิ่ม</button></a>
                    </div>
                </form>
                <table class = "showStdTable">
                    <tr>
                        ...
                        <th width="13%" class ="headColor"><a href="EditCourseAdmin.php">แก้ไข</a></th>
                        <th width="13%" class ="headColor">ลบ</th>
                    </tr>
                <?php
                    $sql = 'SELECT c.ID_C, c.Name_C, c.Detail_C, ca.Name_Ca, tc.Name_T FROM course as c, teach as t, teacher as tc, category as ca WHERE c.ID_Ca = ca.ID_Ca AND c.ID_C = t.ID_C AND t.ID_T = tc.ID_T'; 
