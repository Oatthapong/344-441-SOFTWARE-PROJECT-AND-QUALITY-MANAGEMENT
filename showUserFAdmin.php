...
<!DOCTYPE html>
    <html>
        <head>
            ...
            <link href="showUser.css" rel="stylesheet" />
        </head>
        <body>
        <ul>
            ...
            <div class="container m-auto">
                ...
                <form class="formSearchUser" method="get" action="showUserFAdminFin.php">
                    <div class="topnav mt-3 mb-5 ml-3">
                        ...
                        <input class="btn-primary" value="ค้นหา" name="btnSubmit" type="submit">
                    </div>
                </form>
                    ...
                    if(mysqli_num_rows($result) > 0){
                        while($row = mysqli_fetch_assoc($result)){
                            echo "<tr>";
                                ...
                                echo "<td><a class='btn btn-warning' href='updatestudent-AD.php'?username_id=".$row['Username']."'>แก้ไข</a></td>";
                                echo '<td>';
